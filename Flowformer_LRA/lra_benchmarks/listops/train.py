...
config_flags.DEFINE_config_file(
    'config', './listops/configs/flowformer_base.py', 'Training configuration.', lock_config=True)
flags.DEFINE_string(
    'model_dir', default='./experiments/flowformer_new', help='Directory to store model data.')
flags.DEFINE_string(
    'task_name',
    default='basic',
    help='Name of the task used for load training/test data.')
flags.DEFINE_string(
    'data_dir', default='/data/lra/listops-1000/', help='Directory containing datasets.')
flags.DEFINE_string(
    'model_type', default='', help='model_type')
flags.DEFINE_bool(
...
def main(argv):
    ...
    for step, batch in zip(range(start_step, num_train_steps), train_iter):
        ...
        if step % eval_freq == 0 and step > 0:
            ...
            eval_summary = run_eval(test_ds, num_eval_steps)
