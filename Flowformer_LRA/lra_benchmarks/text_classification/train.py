...
config_flags.DEFINE_config_file(
    'config', './text_classification/configs/flowformer_base.py', 'Training configuration.', lock_config=True)
flags.DEFINE_string(
...
flags.DEFINE_string(
    'data_dir', default='/data/lra/', help='Directory containing datasets.')
flags.DEFINE_string(
